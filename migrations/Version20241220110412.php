 ...
 */
final class Version20241220110412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE token_utilisateur (id INT NOT NULL, utilisateur_id INT DEFAULT NULL, token VARCHAR(255) NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
